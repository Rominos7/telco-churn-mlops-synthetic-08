...
try:
    ...
    print("❌ Локально не встановлено 'joblib'/'scikit-learn' — це НЕ означає,")
    print("   що churn_model.pkl пошкоджений, лише що host python3 не має")
    print("   потрібних пакетів. Онови: pip install joblib scikit-learn pandas")
    print("   (або перевір усередині вже зібраного образу лабораторних:")
    print("   docker compose -f docker-compose.yml -f docker-compose.theme9.yml")
    print("   run --rm --entrypoint python lab-setup scripts/theme9_verify_artifacts.py)")
    exit_code = 1
    joblib = None
